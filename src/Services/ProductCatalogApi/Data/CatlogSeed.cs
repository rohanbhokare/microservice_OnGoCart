...
public class CatalogSeed
    {
        ...
        public CatalogSeed(CatalogContext context)
        {
            _context = context;
        }
        public void SeedAsync()
        {
            ...
            {
                _context.CatalogBrands.AddRange(GetPreconfiguredCatalogBrands());
                 _context.SaveChangesAsync();
            }
            if (!_context.CatalogTypes.Any())
                {
                _context.CatalogTypes.AddRange(GetPreconfiguredCatalogTypes());
                 _context.SaveChangesAsync();
            }

            if (!_context.CatalogItems.Any())
            {
                _context.CatalogItems.AddRange(GetPreconfiguredItems());
                 _context.SaveChangesAsync();
            }
